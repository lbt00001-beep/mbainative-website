...
const SocialIcon = ({ href, label, children }: { href: string, label: string, children: React.ReactNode }) => (
  <a href={href} aria-label={label} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[--accent] transition-colors">
    {children}
  </a>
);
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <SocialIcon label="MBAI Native en X" href="https://x.com/MBAInative">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
            </SocialIcon>
            <SocialIcon label="MBAI Native en Instagram" href="https://www.instagram.com/mbainative">
            ...
            <SocialIcon label="MBAI Native en Facebook" href="https://www.facebook.com/profile.php?id=61585617150280">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
            </SocialIcon>
            <SocialIcon label="MBAI Native en YouTube" href="https://www.youtube.com/channel/UCRDGzWUXnAA_r3AdIPq-Ekw">
      ...
      <div className="container mx-auto border-t border-gray-700 pt-8 mt-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm text-gray-400">
            ...
            <Link href="/precisiones" className="hover:text-[--accent] transition-colors">
              Precisiones
            </Link>
          </div>
        </div>
